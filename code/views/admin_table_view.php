...
<form method="post" action="">
	...
	<table class='lined_table' rules="all">
		...
		<?php foreach($this->data['content']['data'] as $num=>$string):?>	
			<tr>
				<td><?=$num?></td>
				<td><?=$this->form->createButton('btn_event btn_edit_row','',array("formaction='/admin/edit/".$num."'"))?></td>
	...
	<nav class="form_container">
		<?=$this->form->createButton('btn_form btn_apply','Создать запись',array("formaction='/admin/edit/'"))?>
